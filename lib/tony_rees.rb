  ...
  (1..v_str1_length).each do |s|
    ...
    (1..v_str2_length).each do |t|
      ...
      while v_temp_block_length >= 1
        ...
        if p_block_limit > 1 && s >= (v_temp_block_length * 2) && t >= (v_temp_block_length * 2) && v_temp_str1[s1, v_temp_block_length] == v_temp_str2[t1, v_temp_block_length] && v_temp_str1[s2, v_temp_block_length] == v_temp_str2[t2, v_temp_block_length]
          # puts 'tr'
          # puts [s,t].join ","
