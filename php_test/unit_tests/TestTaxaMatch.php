...
class TestTaxaMatch extends UnitTestCase
{
	...
	function testMatchGenera()
	{
		...
		$this->assertTrue($match['edit_distance'] == 15);
		...
		$this->assertTrue($match['match']);
		$this->assertTrue($match['phonetic_match']);
		$this->assertTrue($match['edit_distance'] == 8);

		//First letter is the same and distance is 2 should match, no phonetic match
		$g1 = 'Xantherii';
		$g2 = 'Xantherrr';
		$match = $this->tm->match_genera($g1, $g2);
		$this->assertTrue($match['match']);
	...
	function testMatchSpeciesEpithets()
	{
		...
		$this->assertTrue($match['match']);
		$this->assertTrue($match['phonetic_match']);
		$this->assertTrue($match['edit_distance'] == 9);
	...
	function testMatchBionomials()
	{
		...
		$match = $this->tm->match_binomials($genus_match, $species_epithet_match);
		$this->assertTrue($match['match']);
		$this->assertTrue($match['phonetic_match']);
